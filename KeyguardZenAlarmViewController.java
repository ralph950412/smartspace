...
public final class KeyguardZenAlarmViewController {
    ...
    public KeyguardZenAlarmViewController(Context context, BcSmartspaceDataPlugin bcSmartspaceDataPlugin, ZenModeInteractor zenModeInteractor, AlarmManager alarmManager, NextClockAlarmController nextClockAlarmController, Handler handler, CoroutineScope coroutineScope) {
